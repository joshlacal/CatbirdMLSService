    ...
    private func processPendingAddition(pendingId: String, convoId: String) async {
        ...
        do {
            ...
            guard let keyPackageBase64 = claimResult.keyPackage?.keyPackage,
                ...
                logger.error("❌ [KEY_PACKAGE_EXHAUSTION] Claim succeeded but no key package provided for device: \(deviceDid)")
                ...
                do {
                    ...
                    if requested {
                        ...
                        logger.warning("   ⚠️ No active members to refresh GroupInfo - device may be stuck")
                    }
                } catch {
